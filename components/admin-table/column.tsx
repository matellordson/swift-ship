...
export const columns: ColumnDef<Shipment>[] = [
  ...
  {
    accessorKey: "stageLocation",
    header: "Stage Location",
    cell: ({ row }) => {
      const date = row.original.stageLocation
      return format(date, "yyyy-MM-dd HH:mm:ss")
    },
  },
  {
    accessorKey: "StageIsCompleted",
    header: "Stage Completed",
    cell: ({ row }) => {
      return row.original.StageIsCompleted ? "Yes" : "No"
    },
  },
  {
    id: "actions",
    cell: ({ row }) => {
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuLabel>Actions</DropdownMenuLabel>
            <DropdownMenuItem onClick={() => navigator.clipboard.writeText(shipment.tracking_id)}>
              Copy tracking ID
            </DropdownMenuItem>
            <DropdownMenuSeparator />
            <Link href={`/admin-dashboard/${shipment.tracking_id}`}>
            ...
            <Dialog open={isDateOpen} onOpenChange={setIsDateOpen}>
              <DialogTrigger asChild>
                <DropdownMenuItem onSelect={(e) => e.preventDefault()}>Update Delivery Date</DropdownMenuItem>
              </DialogTrigger>
              <DialogContent className="w-fit">
                <DialogHeader>
                  <DialogTitle>Update Delivery Date</DialogTitle>
