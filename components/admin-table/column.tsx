...
export const columns: ColumnDef<Shipment>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      useEffect(() => {
        const storedStages = localStorage.getItem(`stages_${shipment.tracking_id}`);
        const storedCurrentStage = localStorage.getItem(`currentStage_${shipment.tracking_id}`);
      ...
      useEffect(() => {
        localStorage.setItem(`stages_${shipment.tracking_id}`, JSON.stringify(stages));
        localStorage.setItem(`currentStage_${shipment.tracking_id}`, currentStage.toString());
